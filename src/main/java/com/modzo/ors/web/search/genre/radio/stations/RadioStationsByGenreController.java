...
public class RadioStationsByGenreController {
    ...
    public ModelAndView searchBySong(
        ...
        items.put(ComponentType.PAGE_TITLE.getName(), nonSeoTitle + " results of free online "
                + "radio stations, free mp3, aac music at OnlineRadioSearch.com. Page "
                + (pageable.getPageNumber() + 1));

        items.put(ComponentType.DESCRIPTION.getName(), nonSeoTitle + " online free radio search results. Browse "
